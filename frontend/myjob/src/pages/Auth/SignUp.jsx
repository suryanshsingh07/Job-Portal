...
import {User, Upload, Mail, UserCheck, Lock, Eye, EyeOff, Loader, Building2, CheckCircle, AlertCircle, TypeIcon} from 'lucide-react'
...
const SignUp = () => {
  ...
  const handleSubmit=async(e)=>{
    ...
    console.warn("Image upload failed, continuing without avatar:", err);
    avatarUrl = ""; 
  }
      }
        ...
        <div className='min-h-screen flex items-center justify-center bg-gray-50 px-4'>
          ...
          className='bg-white p-8 rounded-xl shadow-lg max-w-md w-full text-center'>
            ...
            <p className='text-gray-600 mb-4'>
              Welcome to My Job! Your account has been successfully created
            </p>
        ...
        <form onSubmit={handleSubmit} className='space-y-6'>
          <div>
            ...
            <div className='relative'>
              ...
              <input type='text' name='fullName' value={formData.fullName} placeholder='Enter your Full Name' onChange={handleInputChange} onBlur={validateForm}
          ...
          <div>
            ...
            <div className='relative'>
              ...
              className={`w-full pl-10 pr-12 py-3 rounded-lg border ${formState.errors.email ? "border-red-500" : 'border-gray-300'} focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors`}/>
            </div>
          ...
          <div>
            ...
            <div className='relative'>
              ...
              <input type={formState.showPassword ? 'text' : 'password'} name='password' value={formData.password} placeholder='Enter your Password' onChange={handleInputChange}
              ...
              <button type='button' onClick={()=> setFormState((prev)=>({
                ...prev,
          ...
          <div>
            ...
            <div className='flex items-center space-x-4'>
              <div className='w-16 h-16 rounded-full bg-gray-100 flex items-center justify-center overflow-hidden'>
                {formState.avatarPreview ? (<img src={formState.avatarPreview} alt="Avatar Preview" className='w-full h-full object-cover'/>) : (<User className='w-8 h-8 text-gray-400'/>)}
              </div>
          ...
          <div>
            ...
            <div className='grid grid-cols-2 gap-4'>
              <button type='button' onClick={()=> handleRoleChange("jobseeker")}
              ...
              <button type='button' onClick={()=> handleRoleChange("employer")}
                className={`p-4 rounded-lg border-2 transition-all ${formData.role === "employer" ? "border-blue-500 bg-blue-50 text-blue-700" : "border-gray-200 hover:border-gray-300"}`}>
                  ...
                  <div className='text-xs text-gray-500'>
                    Wanted to Hire talented candidates
                  </div>
              </button>
            </div>
