...
const Hero = () => {
    ...
    return (
        <section className='pt-0 pb-0 bg-white min-h-screen flex items-center'>
            <div className='container mx-auto px-4'>
                <div className='max-w-4xl mx-auto text-center'>
                    <motion.h1
                        ...
                        className='text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 mb-6 leading-tight pt-24'>
                    ...
                    <motion.div
                        ...
                        <motion.button
                            ...
                            onClick={() => {
                                navigate(
                                    isAuthenticated && user?.role === "employer" ? "/employer_dashboard" : "/login"
                                );
                            }}>
                            Post a Job
                        </motion.button>
            ...
            <div className='absolute inset-0 overflow-hidden pointer-events-none'>
                <div className='absolute top-2 left-10 w-32 h-32 bg-blue-100 rounded-full blur-3xl opacity-30'></div>
